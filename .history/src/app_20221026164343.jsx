...
function App({
  ...
  const removeOpponentData = () => {
    (
      opponentStartMarker,
      opponentStartCircle,
      opponentArriveMarker,
      opponentArriveCircle
    ) => {
    ...
    setOpponentStartMarker(null);
    setOpponentArriveMarker(null);
    setOpponentStartCircle(null);
    setOpponentArriveCircle(null);
  };
