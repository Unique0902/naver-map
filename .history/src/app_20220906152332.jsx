...
function App() {
  ...
  const [arrivePosition, setArrivePosition] = useState(null);
  ...
  const selectPosition = () => {
    if(nowSettingPos==='start'){
      setStartPosition(marker.getPosition())l
      setStartMarker(new navermaps.Marker({position:marker.getPosition(),map:map}));
      setStartCircle(new navermaps.Circle({map: map,
      ...
      setArrivePosition(marker.getPosition())l
      setArriveMarker(new navermaps.Marker({position:marker.getPosition(),map:map}));
      setArriveCircle(new navermaps.Circle({map: map,
        center: circle.getCenter(),
        radius: circle.getRadius(),
        strokeColor: '#5347AA',
        strokeOpacity: 0.5,
