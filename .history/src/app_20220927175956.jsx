  ...
  return (
    <>
      ...
      <section className={styles.selBtns}>
        {(nowSettingPos === 'start' || nowSettingPos === 'arrive') && (
          <button
        ...
        {nowSettingPos === 'end' && (
          <button className={styles.matchingBtn}>매칭하기</button>
        )}
        {(nowSettingPos === 'end' || nowSettingPos === 'arrive') && (
          <button
        ...
        {nowSettingPos === 'end' ? (
          <>
            <div className={styles.lowTopBtns}>
              <button className={styles.lowTopBtn}>출발</button>
              <button className={styles.lowTopBtn}>도착</button>
            </div>
            <button className={styles.lowBtn}>매칭하기</button>
          </>
        ) : (
          <>
            <button
