...
function App({ findMatchingService, chatService, chattingRoomService }) {
  ...
  return (
    <>
      ...
      {nowSettingPos === 'connected' && (
        <button className={styles.matchingCancelBtn} onClick={() => {}}>
          취소하기
        </button>
      )}
      {nowSettingPos === 'end' && (
      ...
      {nowSettingPos === 'connected' && (
        <Chats chattingArr={chattingArr} setChattingArr={setChattingArr} />
      )}
      {nowSettingPos === 'connected' && (
